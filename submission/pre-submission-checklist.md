...
Verified against the *Mathematical Social Sciences* Guide for Authors on
2026-06-22.
...
- Replace `Author names omitted for review` with the definitive author list,
  affiliations, postal addresses, corresponding-author email, and contact details.
  MSS uses single-anonymized review; author names should not be omitted.
...
- Complete Elsevier's separate declaration-of-interests Word document.
