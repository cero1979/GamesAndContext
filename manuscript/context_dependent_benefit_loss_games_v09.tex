...
\title{Transporting Benefit--Loss Classes Across Contexts: Invariance and Equilibrium in Finite Games}
...
\noindent\textbf{Keywords:} benefit--loss classification; contextual games; strategic equivalence; Nash equilibrium; robustness; welfare; social modeling.
...
Existing formalizations inspired by Cipolla have explored evolutionary games, imitation dynamics, spatial interaction, agent-based modeling, and biophysical interpretations \cite{Kuperman2020, Barcenas2020, Tettamanzi2014, PerissiBardi2021}. These works establish that Cipolla's plane can support nontrivial games and population dynamics. Separately, social context games keep the players and strategies of an underlying game while using a network and aggregation rule to transform utilities \cite{AshlagiKrystaTennenholtz2008}. We do not claim priority for either embedding payoffs in games or allowing context to modify utility. Our question concerns the comparative semantics that remains between the two:
\begin{quote}
...
computed from the base payoffs \cite{AshlagiKrystaTennenholtz2008}. Subsequent
...
\cite{TewoldeConitzer2024}. Strategic equivalence, however, is insensitive to
...
transform players' utilities \cite{AshlagiKrystaTennenholtz2008}; relational
utility similarly changes canonical games through social norms
\cite{SuMorsky2024}.  Our comparative problem is different.  We take a family
...
\bibitem{AshlagiKrystaTennenholtz2008}
